...
import com.dreamlex.operations.process.ProcessReports;
...
//                                ProcessAction.ProcessProduction(user, action.getCityOwner(), null, squadron); 
                        ...
                        {
                            Iterator<IoSession> iter = DreamlexServer.protocolHandler.sessions.iterator();
                            while (iter.hasNext())
                            {
                                   ...
                                   (((User)s.getAttribute("user")).getCurrentCityId().intValue() == action.getCityOwner().getId().intValue())) {
                                        switch(action.getType()) {
                                            ...
                                            case ActionType.EVENTDOWNGRADE: 
                                                DreamlexServer.protocolHandler.sessionWrite(s, bl); 
                                                al = new ActionList(1, ProcessAction.getActionsByCity(action.getCityOwner()));
                                                DreamlexServer.protocolHandler.sessionWrite(s, al); 
                                                break;  
                                            case ActionType.EVENTSCIENCE: 
                                                DreamlexServer.protocolHandler.sessionWrite(s, scl); 
                                                al = new ActionList(1, ProcessAction.getActionsByCity(action.getCityOwner()));
                                                DreamlexServer.protocolHandler.sessionWrite(s, al); 
                                                break;  
                                            ...
                                            case ActionType.EVENTPRODUCTION: 
                                                ...
                                                DreamlexServer.protocolHandler.sessionWrite(s, productionList);
                                                al = new ActionList(1, ProcessAction.getActionsByCity(action.getCityOwner()));
                                                DreamlexServer.protocolHandler.sessionWrite(s, al); 
...
//                                                DreamlexServer.protocolHandler.sessionWrite(s, p); 
                                                ...
                                                ItemList itemList = new ItemList(1, 
                                                                            ...
                                                                            0, 
                                                                            productions);
                                                DreamlexServer.protocolHandler.sessionWrite(s, itemList); 
                                                break;  
                                            ...
                                            case ActionType.EVENTMYTRADERETURN: 
                                                ...
                                                DreamlexServer.protocolHandler.sessionWrite(s, sl); 
                                                break;
                                            ...
                                            if (s.isConnected()) {
                                                switch(action.getType()) {
                                                    ...
                                                    case ActionType.EVENTMYATTACKPROCESS:
                                                        ...
                                                        DreamlexServer.protocolHandler.sessionWrite(s, rs);
                                                }
